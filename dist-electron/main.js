...
let Messages$1 = class Messages extends APIResource {
  ...
  list(completionID, query = {}, options2) {
    return this._client.getAPIList(path`/chat/completions/${completionID}/messages`, CursorPage, { query, ...options2 });
  }
};
...
let Completions$1 = class Completions extends APIResource {
  ...
  retrieve(completionID, options2) {
    return this._client.get(path`/chat/completions/${completionID}`, options2);
  }
  /**
  ...
  update(completionID, body, options2) {
    return this._client.post(path`/chat/completions/${completionID}`, { body, ...options2 });
  }
  /**
  ...
  delete(completionID, options2) {
    return this._client.delete(path`/chat/completions/${completionID}`, options2);
  }
  parse(body, options2) {
...
class Batches extends APIResource {
  ...
  retrieve(batchID, options2) {
    return this._client.get(path`/batches/${batchID}`, options2);
  }
  /**
  ...
  cancel(batchID, options2) {
    return this._client.post(path`/batches/${batchID}/cancel`, options2);
  }
}
...
let Threads$1 = class Threads extends APIResource {
  ...
  listItems(threadID, query = {}, options2) {
    return this._client.getAPIList(path`/chatkit/threads/${threadID}/items`, ConversationCursorPage, { query, ...options2, headers: buildHeaders([{ "OpenAI-Beta": "chatkit_beta=v1" }, options2 == null ? void 0 : options2.headers]) });
  }
};
  ...
  async poll(runId, params, options2) {
    ...
    const headers = buildHeaders([
      options2 == null ? void 0 : options2.headers,
      {
        ...
        "X-Stainless-Custom-Poll-Interval": ((_a2 = options2 == null ? void 0 : options2.pollIntervalMs) == null ? void 0 : _a2.toString()) ?? void 0
      }
    ]);
    while (true) {
...
let Files$2 = class Files extends APIResource {
  ...
  create(containerID, body, options2) {
    return this._client.post(path`/containers/${containerID}/files`, multipartFormRequestOptions({ body, ...options2 }, this._client));
  }
  /**
  ...
  retrieve(fileID, params, options2) {
    const { container_id } = params;
    return this._client.get(path`/containers/${container_id}/files/${fileID}`, options2);
  }
  /**
...
class Containers extends APIResource {
  ...
  retrieve(containerID, options2) {
    return this._client.get(path`/containers/${containerID}`, options2);
  }
  /**
   * List Containers
   */
...
class Items extends APIResource {
  ...
  retrieve(itemID, params, options2) {
    ...
    return this._client.get(path`/conversations/${conversation_id}/items/${itemID}`, { query, ...options2 });
  }
  /**
   * List all items for a conversation with the given ID.
   */
  list(conversationID, query = {}, options2) {
    return this._client.getAPIList(path`/conversations/${conversationID}/items`, ConversationCursorPage, { query, ...options2 });
  }
  /**
  ...
  delete(itemID, params, options2) {
    ...
    return this._client.delete(path`/conversations/${conversation_id}/items/${itemID}`, options2);
  }
}
class Conversations extends APIResource {
  ...
  retrieve(conversationID, options2) {
    return this._client.get(path`/conversations/${conversationID}`, options2);
  }
  /**
   * Update a conversation
   */
  update(conversationID, body, options2) {
    return this._client.post(path`/conversations/${conversationID}`, { body, ...options2 });
  }
  /**
   * Delete a conversation. Items in the conversation will not be deleted.
   */
  delete(conversationID, options2) {
    return this._client.delete(path`/conversations/${conversationID}`, options2);
  }
}
...
class OutputItems extends APIResource {
  ...
  retrieve(outputItemID, params, options2) {
    ...
    return this._client.get(path`/evals/${eval_id}/runs/${run_id}/output_items/${outputItemID}`, options2);
  }
  /**
  ...
  list(runID, params, options2) {
    ...
    return this._client.getAPIList(path`/evals/${eval_id}/runs/${runID}/output_items`, CursorPage, { query, ...options2 });
  }
}
class Runs2 extends APIResource {
  ...
  create(evalID, body, options2) {
    return this._client.post(path`/evals/${evalID}/runs`, { body, ...options2 });
  }
  /**
  ...
  retrieve(runID, params, options2) {
    ...
    return this._client.get(path`/evals/${eval_id}/runs/${runID}`, options2);
  }
  /**
  ...
  delete(runID, params, options2) {
    const { eval_id } = params;
    return this._client.delete(path`/evals/${eval_id}/runs/${runID}`, options2);
  }
  /**
  ...
  cancel(runID, params, options2) {
    const { eval_id } = params;
    return this._client.post(path`/evals/${eval_id}/runs/${runID}`, options2);
  }
}
...
class Evals extends APIResource {
  ...
  retrieve(evalID, options2) {
    return this._client.get(path`/evals/${evalID}`, options2);
  }
  /**
   * Update certain properties of an evaluation.
   */
  update(evalID, body, options2) {
    return this._client.post(path`/evals/${evalID}`, { body, ...options2 });
  }
  /**
  ...
  delete(evalID, options2) {
    return this._client.delete(path`/evals/${evalID}`, options2);
  }
}
Evals.Runs = Runs2;
let Files$1 = class Files2 extends APIResource {
  ...
  retrieve(fileID, options2) {
    return this._client.get(path`/files/${fileID}`, options2);
  }
  /**
  ...
  delete(fileID, options2) {
    return this._client.delete(path`/files/${fileID}`, options2);
  }
  /**
...
class Permissions extends APIResource {
  ...
  create(fineTunedModelCheckpoint, body, options2) {
    return this._client.getAPIList(path`/fine_tuning/checkpoints/${fineTunedModelCheckpoint}/permissions`, Page, { body, method: "post", ...options2 });
  }
  /**
  ...
  delete(permissionID, params, options2) {
    ...
    return this._client.delete(path`/fine_tuning/checkpoints/${fine_tuned_model_checkpoint}/permissions/${permissionID}`, options2);
  }
}
...
class Checkpoints2 extends APIResource {
  ...
  list(fineTuningJobID, query = {}, options2) {
    return this._client.getAPIList(path`/fine_tuning/jobs/${fineTuningJobID}/checkpoints`, CursorPage, { query, ...options2 });
  }
}
class Jobs extends APIResource {
  ...
  retrieve(fineTuningJobID, options2) {
    return this._client.get(path`/fine_tuning/jobs/${fineTuningJobID}`, options2);
  }
  /**
  ...
  cancel(fineTuningJobID, options2) {
    return this._client.post(path`/fine_tuning/jobs/${fineTuningJobID}/cancel`, options2);
  }
  /**
  ...
  listEvents(fineTuningJobID, query = {}, options2) {
    return this._client.getAPIList(path`/fine_tuning/jobs/${fineTuningJobID}/events`, CursorPage, { query, ...options2 });
  }
  /**
  ...
  pause(fineTuningJobID, options2) {
    return this._client.post(path`/fine_tuning/jobs/${fineTuningJobID}/pause`, options2);
  }
  /**
  ...
  resume(fineTuningJobID, options2) {
    return this._client.post(path`/fine_tuning/jobs/${fineTuningJobID}/resume`, options2);
  }
}
...
class Models extends APIResource {
  ...
  retrieve(model, options2) {
    return this._client.get(path`/models/${model}`, options2);
  }
  /**
  ...
  delete(model, options2) {
    return this._client.delete(path`/models/${model}`, options2);
  }
}
...
class InputItems extends APIResource {
  ...
  list(responseID, query = {}, options2) {
    return this._client.getAPIList(path`/responses/${responseID}/input_items`, CursorPage, { query, ...options2 });
  }
}
...
class Responses extends APIResource {
  ...
  cancel(responseID, options2) {
    return this._client.post(path`/responses/${responseID}/cancel`, options2);
  }
  /**
...
class Parts extends APIResource {
  ...
  create(uploadID, body, options2) {
    return this._client.post(path`/uploads/${uploadID}/parts`, multipartFormRequestOptions({ body, ...options2 }, this._client));
  }
}
class Uploads extends APIResource {
  ...
  cancel(uploadID, options2) {
    return this._client.post(path`/uploads/${uploadID}/cancel`, options2);
  }
  /**
   * Completes the
  ...
  complete(uploadID, body, options2) {
    return this._client.post(path`/uploads/${uploadID}/complete`, { body, ...options2 });
  }
}
Uploads.Parts = Parts;
...
class FileBatches extends APIResource {
  ...
  listFiles(batchID, params, options2) {
    ...
    return this._client.getAPIList(path`/vector_stores/${vector_store_id}/file_batches/${batchID}/files`, CursorPage, { query, ...options2, headers: buildHeaders([{ "OpenAI-Beta": "assistants=v2" }, options2 == null ? void 0 : options2.headers]) });
  }
  /**
...
class Files3 extends APIResource {
  ...
  content(fileID, params, options2) {
    const { vector_store_id } = params;
    return this._client.getAPIList(path`/vector_stores/${vector_store_id}/files/${fileID}/content`, Page, { ...options2, headers: buildHeaders([{ "OpenAI-Beta": "assistants=v2" }, options2 == null ? void 0 : options2.headers]) });
  }
}
...
class Videos extends APIResource {
  ...
  retrieve(videoID, options2) {
    return this._client.get(path`/videos/${videoID}`, options2);
  }
  /**
   * List videos
   */
  ...
  delete(videoID, options2) {
    return this._client.delete(path`/videos/${videoID}`, options2);
  }
  /**
  ...
  remix(videoID, body, options2) {
    return this._client.post(path`/videos/${videoID}/remix`, maybeMultipartFormRequestOptions({ body, ...options2 }, this._client));
  }
}
...
class OpenAI {
  ...
  async makeRequest(optionsInput, retriesRemaining, retryOfRequestLogID) {
    ...
    if ((_a2 = options2.signal) == null ? void 0 : _a2.aborted) {
      throw new APIUserAbortError();
    }
